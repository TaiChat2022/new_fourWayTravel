...
const AboutFTW = () => {
	return (
		<>
			...
			<div className="fresnel-container fresnel-greaterThanOrEqual-2xl w-full bg-2">
				<section className="w-78 m-auto">
					<div className="bg-grey-200">
						<div className="mx-auto pt-6 pb-3 Wrapper_content__FmHBo px-7 2xs:px-8 l:px-14 2xl:px-5">
							<h2 className="text-heading-l font-bold text-2xl ">
								Về <span>fourwaytravel</span>
							</h2>
						</div>
						<div className="bg-grey-200">
							<div className="mx-auto pb-6 Wrapper_content__FmHBo px-7 2xs:px-8 l:px-14 2xl:px-5">
								<div className="space-y-3 2xl:space-y-0 2xl:grid 2xl:grid-cols-2 2xl:gap-4">
									<div className="bg-white rounded-md p-4">
										...
										<p className="text-m text-xm overflow-hidden leading-loose ExpandableText_collapsable__7vAW5 ExpandableText_normalText__JnhSF">
											Chỉ với vài lượt bấm, hệ thống tìm kiếm khách sạn của fourwaytravel hỗ trợ
											người dùng so sánh giá phòng giữa hàng trăm website đặt phòng với hơn 5
									...
									<div className="bg-white rounded-md p-4">
										...
										<p className="text-m text-xm overflow-hidden leading-loose ExpandableText_collapsable__7vAW5 ExpandableText_normalText__JnhSF">
											...
											. Nhập địa điểm bạn muốn đến và ngày dự định đi và hãy để công cụ tìm kiếm
											của chúng tôi so sánh giá cả chỗ ở cho bạn. Để điều chỉnh các kết quả tìm
											kiếm, bạn có thể lọc theo giá, khoảng cách (VD: từ bãi biển), số lượng sao,
									...
									<div className="bg-white rounded-md p-4">
										...
										<p className="text-m text-xm leading-loose overflow-hidden ExpandableText_collapsable__7vAW5 ExpandableText_normalText__JnhSF">
											Cơ sở dữ liệu gồm hơn <b className="text-xm">175 triệu đánh giá</b> và hơn
											19 triệu ảnh của chúng tôi giúp bạn hiểu rõ hơn về nơi mình định đến. Để có
									...
									<div className="bg-white rounded-md p-4">
										<h3 className="text-heading-m font-bold mb-3 text-lg">Cách đặt phòng</h3>
										<p className="text-m text-xm overflow-hidden ExpandableText_collapsable__7vAW5 ExpandableText_normalText__JnhSF leading-loose	">
											fourwaytravel là một công cụ so sánh và tìm kiếm giá phòng khách sạn tối ưu.
											Giá phòng hiển thị được cung cấp bởi rất nhiều khách sạn và website đặt
										...
										<p className="text-m text-xm overflow-hidden leading-loose ExpandableText_collapsable__7vAW5 ExpandableText_normalText__JnhSF">
											Hãy để fourwaytravel giúp bạn tìm giá lý tưởng từ hàng trăm website khách
											sạn!
										</p>
									</div>
								</div>
