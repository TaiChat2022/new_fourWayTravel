...
// hàm này được viết lại chỉ sd 1 cpn tabpanal
										...
										<div className="box-img relative">
											<div className="backdrop-blur-sm w-full bg-black/30 bottom-0 absolute p-2">
												...
												<h3 className="total-room">
													<span className="total-number">{countsArray[2][index]}</span> lưu
													trú
												</h3>
											</div>
											<img
									...
									>
										<div className="box-img relative">
											<div className="backdrop-blur-sm w-full bg-black/30 bottom-0 absolute p-2">
												<h3 className="name-travel">{item.text}</h3>
												<h3 className="total-room">
													<span className="total-number">{countsArray[1][index]}</span> lưu
													trú
												</h3>
											</div>
											<img
