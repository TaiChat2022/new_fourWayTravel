...
const FavouriteLayout = ({
	Link, userFavorites, currentUser
}) => {
	return (
		<>
			{currentUser ?
									...
									<main className="flex justify-start w-3/4 mx-auto pt-9 max-w-screen-2xl">
										...
										<div className="w-full">
											<div className="px-4">
												...
												<p className="mt-1 mb-3 text-m text-grey-900">
											...
											<Link to="/listluutru">
												...
												>
													<ul className="grid grid-cols-1 gap-4 list-none md:grid-cols-4">
														{userFavorites.map((item) =>
															<>
																<li
																	className="flex-col col-span-1 w-full gap-2 my-3"
																>
																	<Link to='#'>
																		<div className="relative w-52 h-52 ">
																			<img
																				className="h-full rounded-sm cursor-pointer w-full object-cover hover:opacity-75"
																				src={item.img}
																				loading="lazy"
																				draggable="false"
																		...
																		<p className="flex flex-wrap max-w-xs mt-2 font-semibold gap-x-2">
																			{item.danhmuc}
																		</p>
																	</Link>
																</li>
