								...
								<div className="mt-2 bg-white rounded-lg mb-4 h-auto shadow-product">
									...
									>
										...
										<div className="block m-2 col-span-1 relative">
												...
												<div className="flex flex-wrap justify-between ml-3 mr-2 mb-2 pb-2 ">
													...
													<Link
														...
														className={`
															...
															bg-orange-600 text-white  px-2 md:px-0
															text-sm  md:text-xx lg:text-xs hover:bg-orange-700 font-light
														`}
														onClick={() =>
															handleAddToRecentlyViewed(
																item.id,
											...
											<div className="w-full h-14 border-none bg-gray-200 rounded-lg py-2 mt-3 flex gap-2 flex-wrap bg-orange-600 hover:bg-orange-700">
												<button className="w-full md:w-64 h-11 rounded-md  text-white font-light text-base">
													Xem chi tiết
												</button>
											</div>
										</div>
