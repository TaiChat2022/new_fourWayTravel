            ...
            <div className="border border-rgba(68, 117, 243, 1) border-solid border-1 rounded-lg relative">
              <div className="relative">
                ...
                <div className="absolute top-0 left-5 bottom-20 flex flex-col justify-center items-center">
                  ...
                  <span className="text-white text-2xl font-bold">Tp Hồ Chí Minh</span>
                </div>
                <div className="got">
                  <div className="flex items-center justify-between mx-2 my-2  ">
                    <div className="mr-2">
                      <span className="text-xl text-blue-900  font-bold">Đà Lạt</span>
                    </div>
                    <div className="mr-2">
                      <span className="text-lg">500.000đ</span>
                    </div>
                  </div>
                  <div>
                    <span className="text-sm mx-2">305km - 8h - 01/10/2023</span>
                  </div>
                </div>
                <div className="got">
                  <div className="flex items-center justify-between mx-2 my-2  ">
